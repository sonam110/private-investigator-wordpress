...
use INSIGHTEYE\Includes\Classes\Header_Enqueue;
use INSIGHTEYE\Includes\Classes\Options;
...
class Base {
	...
	public static function instance() {
		...
		if ( isset( $GLOBALS['insighteye_base'] ) ) {
			return $GLOBALS['insighteye_base'];
		}
	...
	function option( $key = '' ) {
		...
		$options = (array) get_theme_mod( 'insighteye' . '_options-mods' );

		$dn = insighteye_dot( $options );
	...
	function get_meta( $key = '', $id = '' ) {
		...
		$id = ( $id ) ? $id : insighteye_set( $post, 'ID' );
