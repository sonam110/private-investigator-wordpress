 ...
 */
//insighteye_load_default_hooks
function insighteye_load_default_hooks() {

	$config = insighteye_WSH()->config( 'default' );
...
/**
 * [insighteye_main_header_area description]
 *
 * @return [type] [description]
 */

//insighteye_main_header_area
function insighteye_main_header_area() {
	...
	//need to change
	if ( $header == 'header_v1' ) {
		insighteye_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		insighteye_template_load( 'templates/header/header_v2.php' );
	} elseif ( $header == 'header_v3' ) {
		insighteye_template_load( 'templates/header/header_v3.php' );
	} elseif ( $header == 'header_v4' ) {
		insighteye_template_load( 'templates/header/header_v4.php' );
	} else {
		insighteye_template_load( 'templates/header/default-header.php' );
	}
}
...
/**
 * [insighteye_main_footer_area description]
 *
 * @return [type] [description]
 */
//insighteye_main_footer_area
function insighteye_main_footer_area() {
	...
	//need to change
	if ( $footer == 'footer_v1' ) {
		insighteye_template_load( 'templates/footer/default-footer.php' );
	}  else {
		insighteye_template_load( 'templates/footer/default-footer.php' );
	}
}
...
/**
 * [insighteye_sidebar description]
 *
 * @return [type] [description]
 */
//insighteye_sidebar
function insighteye_sidebar( $data ) {

	insighteye_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [insighteye_banner description]
 *
 * @return [type] [description]
 */
//insighteye_banner
function insighteye_banner( $data ) {

	insighteye_template_load( 'templates/banner/banner.php', compact( 'data' ) );
