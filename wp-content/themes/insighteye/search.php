...
get_header();
global $wp_query;
$data  = \INSIGHTEYE\Includes\Classes\Common::instance()->data( 'search' )->get();
                ...
                <div class="content-side <?php echo esc_attr( $class ); ?> <?php if ( $data->get( 'layout' ) == 'left' ) echo 'pl-0'; elseif ( $data->get( 'layout' ) == 'right' ) echo ''; ?>">
                	<div class="blog-standard-content">
                        ...
                        <div class="thm-sidebar-box default-sidebar">
                            <p class="mb-4"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'insighteye' ); ?></p>
                            <?php get_search_form() ?>
                        </div>
                        <?php endif; ?>
